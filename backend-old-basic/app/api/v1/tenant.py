...
async def get_tenant_stats(
    ...
    try:
        ...
        # Em caso de erro de banco, assumir 0 para não quebrar o dashboard
        encomendas_count = 0
...
async def get_tenant_by_id(tenant_id: int, db: AsyncSession = Depends(get_db)):
    ...
    # ✅ PERFORMANCE: Especificar campos ao invés de SELECT *
    query = text("""
        SELECT id, name, cep, address, number, complement, neighborhood,
               city, state, cnpj, phone, email, logo_url, created_at, updated_at
