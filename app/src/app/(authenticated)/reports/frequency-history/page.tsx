...
interface Item { id: number; user_name: string; access_type: string; access_point: string; registered_at: string; }
export default function FrequencyHistoryPage() {
    ...
    const fetchData = async () => {
        ...
        try {
            const res = await fetch(`${API_BASE}/reports/historico-frequencia?${params}`);
