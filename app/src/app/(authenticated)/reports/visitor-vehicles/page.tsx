...
interface Item { id: number; plate: string; model: string; brand: string; color: string; visitor_name: string; created_at: string; }
export default function VisitorVehiclesPage() {
    ...
    const fetchData = async (search?: string) => {
        ...
        try {
            const res = await fetch(`${API_BASE}/reports/veiculos-visitantes?${params}`);
