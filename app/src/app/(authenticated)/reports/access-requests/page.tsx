...
interface Item { id: number; tipo: string; status: string; motivo: string; user_name: string; created_at: string; }
export default function AccessRequestsPage() {
    ...
    const fetchData = async () => {
        ...
        try {
            const res = await fetch(`${API_BASE}/reports/solicitacoes-acesso?${params}`);
