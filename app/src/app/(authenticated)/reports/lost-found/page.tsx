...
interface Item { id: number; title: string; description: string; item_type: string; location: string; status: string; found_date: string; created_at: string; }
export default function LostFoundPage() {
    ...
    const fetchData = async (search?: string) => {
        ...
        try {
            const res = await fetch(`${API_BASE}/reports/achados-perdidos?${params}`);
