...
interface Item { id: number; name: string; code: string; description: string; location: string; status: string; categoria: string; acquisition_date: string; }
export default function AssetsPage() {
    ...
    const fetchData = async (search?: string) => {
        ...
        try {
            const res = await fetch(`${API_BASE}/reports/ativos?${params}`);
