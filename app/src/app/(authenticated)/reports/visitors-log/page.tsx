...
interface Item { id: number; access_type: string; access_point: string; visitor_name: string; visitor_type: string; registered_at: string; }
export default function VisitorsLogPage() {
    ...
    const fetchData = async () => {
        ...
        try {
            const res = await fetch(`${API_BASE}/reports/visitantes-log?${params}`);
